...
class _EditpostState extends State<Editpost> {
  ...
  @override
  void initState() {
    uploadedMediaUrls = widget.post.images;
    TC.text = widget.post.textContent!;
    super.initState();
  }
                            ...
                            : ElevatedButton(
                                onPressed: () async {
                                  ...
                                  PostModel post = PostModel(
                                    ...
                                    video: uploadedVideo,
                                    date: DateTime.now(),
                                    disLikesNum: widget.post.disLikesNum,
                                    likesNum: widget.post.likesNum,
                                    textContent: TC.text,
                                    userId: provider.userModel!.id,
                                    dislikersList: widget.post.dislikersList,
                                    likersList: widget.post.likersList,
                                  ...
                                  if (response == 1) {
                                    ...
                                    await PostCtr.editPost(postModel: post);
